		...
		<div>
			...
			<div className={classes.contactsItems}>
				<div className={classes.contactItem}>
					...
					<a href='#s' className={classes.contact}>{!props.contacts?.instagram ? 'No information' : props.contacts?.instagram}</a>
				</div>
				<div className={classes.contactItem}>
					<img src={socialNetworkIcon} alt='socialNetworkIcon' className={classes.contactIcon}></img>
					<a href='#s' className={classes.contact}>{!props.contacts?.twitter ? 'No information' : props.contacts?.twitter}</a>
				</div>
				<div className={classes.contactItem}>
					<img src={socialNetworkIcon} alt='socialNetworkIcon' className={classes.contactIcon}></img>
					<a href='#s' className={classes.contact}>{!props.contacts?.facebook ? 'No information' : props.contacts?.facebook}</a>
				</div>
				<div className={classes.contactItem}>
					<img src={socialNetworkIconVk} alt='socialNetworkIconVk' className={classes.contactIcon}></img>
					<a href='#s' className={classes.contact}>{!props.contacts?.vk ? 'No information' : props.contacts?.vk}</a>
				</div>
				<div className={classes.contactItem}>
					<img src={socialNetworkIconYouTube} alt='socialNetworkIconYouTube' className={`${classes.contactIcon} ${classes.borderRadius}`}></img>
					<a href='#s' className={classes.contact}>{!props.contacts?.youtube ? 'No information' : props.contacts?.youtube}</a>
				</div>
				<div className={classes.contactItem}>
					<img src={socialNetworkIconGitHub} alt='socialNetworkIconGitHub' className={classes.contactIcon}></img>
					<a href='#s' className={classes.contact}>{!props.contacts?.github ? 'No information' : props.contacts?.github}</a>
				</div>
				<div className={classes.contactItem}>
					<img src={socialNetworkIcon} alt='socialNetworkIcon' className={classes.contactIcon}></img>
					<a href='#s' className={classes.contact}>{!props.contacts?.website ? 'No information' : props.contacts?.website}</a>
				</div>
				<div className={classes.contactItem}>
					<img src={socialNetworkIconTelegram} alt='socialNetworkIconTelegram' className={`${classes.contactIcon} ${classes.borderRadius}`}></img>
					<a href='#s' className={classes.contact}>{!props.contacts?.mainLink ? 'No information' : props.contacts?.mainLink}</a>
				</div>
			</div>
		</div>
	);
