...
const DemoProjectsItems = (props) => {
	...
	let demoProjectsElements = props.projectsDemoData
		.map(project => <DemoProject key={project.id} id={project.id} iconDemoProject={project.iconDemoProject} name={project.nameDemoProject} />)
